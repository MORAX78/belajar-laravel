...
<tbody>
    ...
    <tr class="student-row">
        <td class="text-center">
            <div class="form-check d-flex justify-content-center m-0">
                <input type="checkbox" class="form-check-input student-checkbox" name="attendances[{{ $index }}][student_id]" value="{{ $student->id }}" id="student_{{ $student->id }}">
            </div>
        </td>
        <td>
    ...
    <tr>
        ...
        Data Student Not Found. <a href="{{ route('student.create') }}">Create Students First</a>
        </td>
    </tr>
    @endforelse
</tbody>
        ...
        studentCheckboxes.forEach(cb => {
            ...
            cb.addEventListener('change', function(){
                ...
                if(checkAll){
                    ...
                    checkAll.indeterminate = checkCount > 0 && checkedCount < studentCheckboxes.length;
                }
            });
        });
